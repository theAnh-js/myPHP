                            ...
                            <tbody>
                                <?php foreach ($list_buy as $item) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo get_format_number($item["price"]) ?></td>
                                        <td>
                                            <input type="number" min="1" max="10" name="quantity[<?php echo $item["id"]?>]" value="<?php echo $item["quantity"] ?>" class="num-order">
                                        </td>
                                        <td><?php echo get_format_number($item["sub_total"]) ?></td>
                                        <td>
